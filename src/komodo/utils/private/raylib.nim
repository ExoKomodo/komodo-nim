...
proc SetShapesTexture*(texture: Texture2D; source: Rectangle) {.RLAPI, importc: "SetShapesTexture".} 
...
proc ColorToHSV*(color: Color): Vector3 {.RLAPI, importc: "ColorToHSV".} # Returns HSV values for a Color, hue [0..360], saturation/value [0..1]
proc ColorFromHSV*(hue: float32; saturation: float32; value: float32): Color {.RLAPI, importc: "ColorFromHSV".} # Returns a Color from HSV values, hue [0..360], saturation/value [0..1]
...
proc LoadMusicStreamFromMemory*(fileType: cstring; data: proc(): uint8; dataSize: int32): Music {.RLAPI, importc: "LoadMusicStreamFromMemory".} # Load music stream from data
