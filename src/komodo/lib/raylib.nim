...
proc GetMonitorWidth*(monitor: int32): int32 {.RLAPI, importc: "GetMonitorWidth".} # Get specified monitor width
proc GetMonitorHeight*(monitor: int32): int32 {.RLAPI, importc: "GetMonitorHeight".} # Get specified monitor height
...
proc GetFileExtension*(fileName: cstring): cstring {.RLAPI, importc: "GetFileExtension".} # Get pointer to extension for a filename string (including point: ".png")
...
proc MeshNormalsSmooth*(mesh: ptr Mesh) {.RLAPI, importc: "MeshNormalsSmooth".} # Smooth (average) vertex normals
